...
public class cafe99 extends AppCompatActivity implements OnMapReadyCallback {
    ...
    @Override
        ...
        N14_Options.position(N14);         N14_Options.snippet("생활과학대학99");        N14_Options.title("N14 CAFE 99");             cafeMap.addMarker(N14_Options);
        N1_Options.position(N1);         N1_Options.snippet("도서관99");        N1_Options.title("N1 CAFE 99");             cafeMap.addMarker(N1_Options);
        N7_Options.position(N7);         N7_Options.snippet("3학생회관99");        N7_Options.title("N7 CAFE 99");             cafeMap.addMarker(N7_Options);

        W8_Options.position(W8);         W8_Options.snippet("1학생회관99, 영탑");        W8_Options.title("W8 CAFE99, YoungTop");       cafeMap.addMarker(W8_Options);

        E5_Options.position(E5);         E5_Options.snippet("2학생회관99");                 E5_Options.title("E5 CAFE99");       cafeMap.addMarker(E5_Options);
        E1_1_Options.position(E1_1);         E1_1_Options.snippet("언어교육원99");                 E1_1_Options.title("E1_1 CAFE99");       cafeMap.addMarker(E1_1_Options);
        E9_Options.position(E9);         E9_Options.snippet("상록회관 와야");                 E9_Options.title("상록회관 WAYA");       cafeMap.addMarker(E9_Options);

        Dom_Options.position(Dom);         Dom_Options.snippet("기숙사 와야");     Dom_Options.title("CAFE WAYA");        cafeMap.addMarker(Dom_Options);
